        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Image.network(
                "https://ip20soft.tech/proautismo/assets/images/tasks-nodes/2.png",
                height: 100,
              ),
              SizedBox(
                height: 16,
              ...
              Image.network(
                "https://ip20soft.tech/proautismo/assets/images/tasks-nodes/5.png",
                height: 100,
              ),
              SizedBox(
                height: 16,
              ...
              Image.network(
                "https://ip20soft.tech/proautismo/assets/images/tasks-nodes/11.png",
                height: 100,
              ),
              SizedBox(
                height: 16,
              ...
              Padding(
                ...
                child: Btn(
                  ...
                  primary: true,
                  onPressed: () async {
                    var r = await startTask(StartTasksReq(widget.task.TaskId,
                        context.mainProvider.currentProfile!.UserProfileId!));
                    if (!r.ok!) {
                      await Alert.alert(context, r.msg!);
                      return;
                    }

                    await context.router.push(SpecialTaskSelectRoute(
                        task: widget.task, activityId: r.data!.ActivityId!));
                  },
                ),
              ),
            ],
